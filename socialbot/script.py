...
_SYSTEM = (
    ...
    "- First line is a HOOK: a surprising fact, a question, or a bold concrete "
    "statement. Never open with 'In this video', 'Today we', or the topic title.\n"
...
Requirements:
  - "narration": ~{target_words} words of spoken voiceover.
      * Line 1 must be a scroll-stopping HOOK (surprising fact / question / bold
        concrete statement) — NOT the topic title restated.
      * Then deliver the key facts in a natural spoken flow.
      * End on a sharp closing line that invites a reaction or follow.
